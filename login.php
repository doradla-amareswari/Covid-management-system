...
<style> body{background-image: url("https://dm0qx8t0i9gc9.cloudfront.net/thumbnails/video/H8WuRINimqur8ud/videoblocks-coronavirus-covid-19-background_rk80xzipu__d_thumbnail-1080_01.png")}</style>
...
<body class="bg-danger">
 ...
 <h3 align="center" style="margin-top:4%;color:#fff">Covid-19 Management System</h3>
                        ...
                        <input type="submit" name="login" class="btn btn-primary btn-user btn-block" value="login">
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="password-recovery.php" style="font-weight:bold">Forgot Password?</a>
                                         ...
                                         <div class="text-center">
                                        <a class="small" href="index.html" style="font-weight:bold;"><i class="fa fa-home" aria-hidden="true"></i> Home Page</a>
                                    </div>
